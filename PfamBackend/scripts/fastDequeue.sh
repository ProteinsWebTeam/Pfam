...
export PATH=$PFAMWEBROOT/PfamBackend/scripts:$PFAMWEBROOT/bin:$PFAMWEBROOT/src/wise2.2.0/src/bin:/software/pfam/bin:$PATH
...
export PATH=$RFAMWEBROOT/bin:$RFAMWEBROOT/src/wublast:$PATH
...
DAEMON=$PFAMWEBROOT/PfamBackend/scripts/fastDequeue.pl
NAME=fastDequeue
