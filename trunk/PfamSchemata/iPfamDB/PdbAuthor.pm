...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:3EYV6S3wzuutJ25IA1LZXw
# These lines were loaded from '/software/pfam/Modules/PfamSchemata/iPfamDB/PdbAuthor.pm' found in @INC.# They are now part of the custom portion of this file# for you to hand-edit.  If you do not either delete# this section or remove that file from @INC, this section# will be repeated redundantly when you re-create this# file again via Loader!
package iPfamDB::PdbAuthor;
...
1;
# End of lines loaded from '/software/pfam/Modules/PfamSchemata/iPfamDB/PdbAuthor.pm' 
