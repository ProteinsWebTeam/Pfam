package PfamLive::Result::PfamaLiteratureReferences;
...
__PACKAGE__->belongs_to(
  "auto_lit",
  "PfamLive::Result::LiteratureReferences",
  { auto_lit => "auto_lit" },
);
...
__PACKAGE__->has_one( "literature" => "PfamLive::Result::LiteratureReferences",
