...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:0FSRJryZlj8XGsTD80Y3OA
# These lines were loaded from '/nfs/production/xfam/pfam/software/Modules/PfamSchemata/PfamLive/Result/ClanArchitecture.pm' found in @INC.
...
1;
# End of lines loaded from '/nfs/production/xfam/pfam/software/Modules/PfamSchemata/PfamLive/Result/ClanArchitecture.pm' 
