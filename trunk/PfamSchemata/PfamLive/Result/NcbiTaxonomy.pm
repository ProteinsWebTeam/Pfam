...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:syTnSFTs0TXWSM8aWOiIGg
# These lines were loaded from '/nfs/production/xfam/pfam/software/Modules/PfamSchemata/PfamLive/Result/NcbiTaxonomy.pm' found in @INC.
...
1;
# End of lines loaded from '/nfs/production/xfam/pfam/software/Modules/PfamSchemata/PfamLive/Result/NcbiTaxonomy.pm' 
