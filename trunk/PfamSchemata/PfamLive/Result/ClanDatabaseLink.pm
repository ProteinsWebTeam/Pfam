...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:E5tbIIGCQGz4zzrETGllUw
# These lines were loaded from '/nfs/production/xfam/pfam/software/Modules/PfamSchemata/PfamLive/Result/ClanDatabaseLink.pm' found in @INC.
...
1;
# End of lines loaded from '/nfs/production/xfam/pfam/software/Modules/PfamSchemata/PfamLive/Result/ClanDatabaseLink.pm' 
