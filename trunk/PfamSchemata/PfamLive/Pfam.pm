...
# $Id: Pfam.pm,v 1.3 2007-03-16 11:25:19 jt6 Exp $
#
# $Author: jt6 $
...
__PACKAGE__->has_many   ( "pdbMap"   => "PfamLive::PdbMap",
			  { "foreign.auto_pfam"  => "self.auto_pfamA" });

__PACKAGE__->has_many   ( "go"       => "PfamLive::GO",
			  { "foreign.auto_pfamA" => "self.auto_pfamA" } );
...
__PACKAGE__->has_one    ( "pfamA_web" => "PfamLive::PfamA_web",
			  {"foreign.auto_pfamA" => "self.auto_pfamA"},
