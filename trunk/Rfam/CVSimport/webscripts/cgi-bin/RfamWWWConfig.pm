...
$file_root = '/nfs/WWW/SANGER_docs/htdocs/Software/Rfam';
...
$srsserver  = "http://srs.sanger.ac.uk/srs6bin/cgi-bin/wgetz?-page+EntryPage+-id+-e+-e+[EMBLRELEASE-acc:ACC]+-view+EmblEntry";
