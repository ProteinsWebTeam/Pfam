...
#	print " TREE:$tree, LIST:$list, DE:$delimiter <P>";
...
sub to_text {
	...
	my $output;
	$depth += 2;
	$output = $tree->convert_to_text($depth, $tag, \$output);
	#print "THE OUT: $output <P>";
	return $output;
}
...
#	print "$tree, $depth, $tag, $ptrOutput, $indent, $flag1, $flag2 <P>";
