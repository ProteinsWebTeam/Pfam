...
This module contains the basic functionality for connecting to the Rfam 
database. The two main modules that rely upon it are Bio::Rfam::DB_RDB,
which provides a query-level interface to the RDB, and rfamrdb which provides
...
=head2 __dump_to_file_sql
 ...
 Usage   : $string = $rdb->_dump_to_file_sql('rfamseq', 'file.txt');
 Function:
...
=head2 __insert_sql
 ...
 Title   : __insert_sql
 Usage   : $string = $rdb->__insert_sql('rfamseq', 5);
 Function:
    This function returns an sql string to insert data into the
...
=head2 __insert_from_file_sql
 ...
 Usage   : $string = $rdb->_insert_sql('rfamseq', 'file.txt');
 Function:
    This function returns an sql string to insert data into the
    given table from the given file.
 Returns :
...
=head2 __replace_sql
 ...
 Title   : __replace_sql
 Usage   : $string = $rdb->__replace_sql('rfamseq', 5);
 Function:
