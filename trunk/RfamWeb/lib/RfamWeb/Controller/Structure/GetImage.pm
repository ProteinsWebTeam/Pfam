...
# jt6 20060314 WTSI
#
# $Id: GetImage.pm,v 1.1 2008-10-23 10:56:26 jt6 Exp $

=head1 NAME

RfamWeb::Controller::Structure::GetImage - serve an image of the
structure

=cut

package RfamWeb::Controller::Structure::GetImage;
...
Serves the image for the specified PDB entry. Redirects to a blank image 
