...
# rdf 20060823 WTSI
#
# $Id: StructuralDomains.pm,v 1.1 2008-10-23 10:56:26 jt6 Exp $

=head1 NAME

RfamWeb::Controller::Structure::StructuralDomains - controller for generating
domain graphics for Pfam, cath and scop

=cut

package RfamWeb::Controller::Structure::StructuralDomains;
