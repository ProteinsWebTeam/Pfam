package PfamWeb::Schema::PfamDB::Clan_membership;
...
__PACKAGE__->has_many( "pfamARegFull" => "PfamWeb::Schema::PfamDB::PfamA_reg_full",
		      {"foreign.auto_pfamA" => "self.auto_pfamA"});

__PACKAGE__->might_have( "pfamAInts" => "PfamWeb::Schema::PfamDB::Int_pfamAs",
		      {"foreign.auto_pfamA_A" => "self.auto_pfamA"});

__PACKAGE__->might_have( "pdbmap" => "PfamWeb::Schema::PfamDB::PdbMap",
