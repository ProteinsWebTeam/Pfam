package PfamWeb::Schema::PfamDB::Int_atoms;
...
__PACKAGE__->has_many( "interactions" => "PfamWeb::Schema::PfamDB::Interactions",
		      {"foreign.auto_int_atoms"  => "self.auto_int_atoms"});

__PACKAGE__->has_one( "bond" => "PfamWeb::Schema::PfamDB::Int_bonds",
