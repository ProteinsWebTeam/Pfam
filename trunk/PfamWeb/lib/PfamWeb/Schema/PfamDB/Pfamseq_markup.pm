package PfamWeb::Schema::PfamDB::Pfamseq_markup;
...
# jt6 20060801 WTSI
__PACKAGE__->has_one("autoMarkup" => "PfamWeb::Schema::PfamDB::Markup_key",
		     {"foreign.auto_markup" => "self.auto_markup"},
		     {proxy => [qw/label/]});

__PACKAGE__->might_have("pdbResidue" => "PfamWeb::Schema::PfamDB::Pdb_residue",
						{"foreign.auto_pfamseq" => "self.auto_pfamseq",
