package PfamWeb::Schema::PfamDB::PfamA2pfamA_PRC_results;
...
__PACKAGE__->has_one( "pfamA1" => "PfamWeb::Schema::PfamDB::Pfam",
		      {"foreign.auto_pfamA"  => "self.auto_pfamA1"},);
		      #{proxy => [qw/pfamA_id pfamA_acc/]});

__PACKAGE__->has_one( "pfamA2" => "PfamWeb::Schema::PfamDB::Pfam",
