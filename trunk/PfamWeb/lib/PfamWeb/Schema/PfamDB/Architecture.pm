...
package PfamWeb::Schema::PfamDB::Architecture;
...
__PACKAGE__->has_one    ( "pfamA_architecture" => "PfamWeb::Schema::PfamDB::PfamA_architecture",
			  {"foreign.auto_architecture" => "self.auto_architecture"},
			{proxy => [qw/auto_pfamA/]});

__PACKAGE__->has_one    ( "type_example" => "PfamWeb::Schema::PfamDB::Pfamseq",
			  {"foreign.auto_pfamseq" => "self.type_example"},
			  {proxy => [ qw/pfamseq_id pfamseq_acc/ ]});

__PACKAGE__->has_one    ( "storable" => "PfamWeb::Schema::PfamDB::Pfam_annseq",
			  {"foreign.auto_pfamseq" => "self.type_example"},
			  {proxy => [ qw/annseq_storable/ ]});

__PACKAGE__->has_one    ( "clan_arch" => "PfamWeb::Schema::PfamDB::ClanArchitecture",
			  {"foreign.auto_architecture" => "self.auto_architecture"},
			{proxy => [qw/auto_clan/]});
1;
