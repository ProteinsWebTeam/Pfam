package PfamWeb::Model::Int_ext_links;
...
__PACKAGE__->has_one( "pfamseq_A" => "PfamWeb::Model::Pfamseq",
		      {"foreign.auto_pfamseq"  => "self.auto_pfamseq_A"});

__PACKAGE__->has_one( "pfamseq_B" => "PfamWeb::Model::Pfam",
		      {"foreign.auto_pfameq"  => "self.auto_pfamseq_B"});

__PACKAGE__->has_one( "int_pfamAs" => "PfamWeb::Model::IntPfamAs",
