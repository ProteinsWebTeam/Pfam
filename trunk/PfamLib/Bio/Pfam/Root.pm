...
This package provides a bare-bones root class for Pfam objects to
inherit from.
Shamelessly stolen from EnsEMBL (who shamelessly stole it from BioPerl).
We use to avoid problems with Bioperl upgrades.
