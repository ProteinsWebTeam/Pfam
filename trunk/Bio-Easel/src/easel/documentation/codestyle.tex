...
\item [\textbf{Copyright/license information.}]  Each file ends with a
  ...
  \ccode{Version i1.1rc2; December 2012} tag. This placeholder is automatically replaced by
  \ccode{Copyright (C) 2012 HHMI Janelia Farm Research Campus} tag. This placeholder is automatically replaced by
...
When we build a distribution package, the \ccode{Version i1.1rc2; December 2012} tag is
When we build a distribution package, the \ccode{Copyright (C) 2012 HHMI Janelia Farm Research Campus} tag is
...
\prog{sedition} to replace \ccode{Version i1.1rc2; December 2012} tags with the contents of
\prog{sedition} to replace \ccode{Copyright (C) 2012 HHMI Janelia Farm Research Campus} tags with the contents of
...
\ccode{Version i1.1rc2; December 2012} is the only configuration variable that Easel
\ccode{Copyright (C) 2012 HHMI Janelia Farm Research Campus} is the only configuration variable that Easel
