...
Bio::iPfam::Config - Provides all of the configuration that you need to run Pfam

=cut

package Bio::iPfam::Config;
...
=head2 new 
  ...
  Title    : new
  Usage    : Either my $config = Bio::Pfan::Config->new or my $config = new Bio::iPfam::Config
  Function : Reads in the config file (location set by the environment varible PFAM_CONFIG
  Args     : None
  Returns  : Bio::iPfam::Config object
...
# edits by pg6, customising for ipfam release,
# I dont need HMMer stuffs,
#
#=head2 hmmer3bin
#
#  Title    : hmmer3bin
...
# edits by pg6, I need neither pfam jobs or svn stuffs,
#
#sub pfamjobs {
#  my $self = shift;
#  if ( $#_ >= 0 ) {
