...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:FXNK6wh71hUNra5b8TdvYQ
# These lines were loaded from '/nfs/production/xfam/pfam/software/Modules/PfamSchemata/PfamLive/Result/PdbResidueData.pm' found in @INC.
...
1;
# End of lines loaded from '/nfs/production/xfam/pfam/software/Modules/PfamSchemata/PfamLive/Result/PdbResidueData.pm' 
