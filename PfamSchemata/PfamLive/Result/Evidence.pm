...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:GAom0FME9QvAzNnPmWl6UQ
# These lines were loaded from '/nfs/production/xfam/pfam/software/Modules/PfamSchemata/PfamLive/Result/Evidence.pm' found in @INC.
...
1;
# End of lines loaded from '/nfs/production/xfam/pfam/software/Modules/PfamSchemata/PfamLive/Result/Evidence.pm' 
