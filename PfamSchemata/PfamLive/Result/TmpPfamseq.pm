...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:urt9hmE5TqHLQefeN2AK8w
# These lines were loaded from '/nfs/production/xfam/pfam/software/Modules/PfamSchemata/PfamLive/Result/TmpPfamseq.pm' found in @INC.
...
1;
# End of lines loaded from '/nfs/production/xfam/pfam/software/Modules/PfamSchemata/PfamLive/Result/TmpPfamseq.pm' 
