...
package PfamWeb::Schema::PfamDB::Pfam;
...
__PACKAGE__->might_have ( "interpro" => "PfamWeb::Schema::PfamDB::Interpro",
...
__PACKAGE__->has_many   ( "go"       => "PfamWeb::Schema::PfamDB::GO",
			  { "foreign.auto_pfamA" => "self.auto_pfamA" } );

__PACKAGE__->has_many   ( "pfamA_lit_refs" => "PfamWeb::Schema::PfamDB::PfamA_literature_references",
			  {"foreign.auto_pfamA"  => "self.auto_pfamA"} );

__PACKAGE__->might_have ( "clan_membership" => "PfamWeb::Schema::PfamDB::Clan_membership",
			  {"foreign.auto_pfamA" => "self.auto_pfamA"},
...
__PACKAGE__->has_many    ( "pfamA_arch" => "PfamWeb::Schema::PfamDB::PfamA_architecture",
			  {"foreign.auto_pfamA" => "self.auto_pfamA"});

__PACKAGE__->has_many( "pfamA_database_links" => "PfamWeb::Schema::PfamDB::PfamA_database_links",
		       {"foreign.auto_pfamA" => "self.auto_pfamA"});
