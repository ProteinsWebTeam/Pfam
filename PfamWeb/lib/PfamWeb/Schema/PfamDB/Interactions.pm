package PfamWeb::Schema::PfamDB::Interactions;
...
__PACKAGE__->has_one( "int_pfamA" => "PfamWeb::Schema::PfamDB::Int_pfamAs",
		      {"foreign.auto_int_pfamA"  => "self.auto_int_pfamA"});

__PACKAGE__->has_one( "int_atoms" => "PfamWeb::Schema::PfamDB::Int_atoms",
...
__PACKAGE__->has_one( "pfamseqA" => "PfamWeb::Schema::PfamDB::Pfamseq",
		      {"foreign.auto_pfamseq"  => "self.auto_pfamseq_A"},
		      {proxy => [qw/pfamseq_id pfamseq_acc/]});

__PACKAGE__->has_one( "pfamseqB" => "PfamWeb::Schema::PfamDB::Pfamseq",
