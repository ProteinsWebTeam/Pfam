...
package PfamWeb::Schema::PfamDB::Clans;
...
__PACKAGE__->has_many( "clan_membership" => "PfamWeb::Schema::PfamDB::Clan_membership",
		       {"foreign.auto_clan"  => "self.auto_clan"});

__PACKAGE__->has_many( "clan_lit_refs" => "PfamWeb::Schema::PfamDB::Clan_lit_refs",
		       {"foreign.auto_clan"  => "self.auto_clan"});

__PACKAGE__->has_many( "clan_database_links" => "PfamWeb::Schema::PfamDB::Clan_database_links",
		       {"foreign.auto_clan"  => "self.auto_clan"});
