...
__PACKAGE__->has_many( "clan_membership" => "PfamWeb::Model::Clan_membership",
		       {"foreign.auto_clan"  => "self.auto_clan"});

__PACKAGE__->has_many( "clan_lit_refs" => "PfamWeb::Model::Clan_lit_refs",
		       {"foreign.auto_clan"  => "self.auto_clan"});

__PACKAGE__->has_many( "clan_database_links" => "PfamWeb::Model::Clan_database_links",
		       {"foreign.auto_clan"  => "self.auto_clan"});
