package PfamWeb::Model::Interactions;
...
__PACKAGE__->has_one( "int_pfamA" => "PfamWeb::Model::Int_pfamAs",
		      {"foreign.auto_int_pfamA"  => "self.auto_int_pfamA"});

__PACKAGE__->has_one( "int_atoms" => "PfamWeb::Model::Int_atoms",
...
__PACKAGE__->has_one( "pfamseqA" => "PfamWeb::Model::Pfamseq",
		      {"foreign.auto_pfamseq"  => "self.auto_pfamseq_A"},
		      {proxy => [qw/pfamseq_id pfamseq_acc/]});

__PACKAGE__->has_one( "pfamseqB" => "PfamWeb::Model::Pfamseq",
