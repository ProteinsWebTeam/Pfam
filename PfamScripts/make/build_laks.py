...
for filename in files: #EAD9.fa
  ...
  os.system(f"sbatch --time=6:00:00 --mem=8G -o \"farm.log\" -e \"farm.log\" -J {name} --wrap=\"liftover_alignment.pl -local -align seed && create_alignment.pl -fasta seed.phmmer -mu > SEED && pfbuild -withpfmake -local && cd .. && pqc-overlap-rdb {name}\"");
