...
mgnifam_scan.pl: search a FASTA file against a library of MGnifam HMMs

Usage: mgnifam_scan.pl -fasta <fasta_file> -dir <directory location of MGnifam files>
...
Additonal options:
  ...
  -e_seq <n>        : specify hmmscan evalue sequence cutoff for MGnifam searches (default MGnifam defined)
  -e_dom <n>        : specify hmmscan evalue domain cutoff for MGnifam searches (default MGnifam defined)
  -b_seq <n>        : specify hmmscan bit score sequence cutoff for MGnifam searches (default MGnifam defined)
  -b_dom <n>        : specify hmmscan bit score domain cutoff for MGnifam searches (default MGnifam defined)
...
mgnifam_scan.pl -- Search protein sequences against the MGnifam HMM library

=head1 SYNOPSIS

mgnifam_scan.pl [options] -fasta <fasta_file> -dir <MGnifam_data_file_dir>

=head1 OPTIONS

=over

=item B<-dir> I<MGnifam_data_file_dir>

Directory containing MGnifam data files [required]
...
Sequence E-value cut-off [default: use MGnifam GA cutoff]

=item B<-e_dom> 

Domain E-value cut-off [default: use MGnifam GA cutoff]

=item B<-b_seq>

Sequence bits score cut-off [default: use MGnifam GA cutoff]

=item B<-b_dom>

Domain bits score cut-off [default: use MGnifam GA cutoff]
...
C<mgnifam_scan.pl> is a script for searching one or more protein sequences against the
library of HMMs from MGnifam. It requires a local copy of the MGnifam data files.
...
Example output:
  ...
  O65039.1     38     93     38     93 PF08246   Inhibitor_I29     Domain     1    58    58     45.9   2.8e-12   1 
  O65039.1    126    342    126    342 PF00112   Peptidase_C1      Domain     1   216   216    296.0   1.1e-88   1 
