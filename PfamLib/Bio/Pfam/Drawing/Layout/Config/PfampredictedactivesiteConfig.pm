# Bio::Pfam::Drawing::Layout::Config::PfampredictedactivesiteConfig
#
# Author:        rdf
# Maintainer:    $Id: PfampredictedactivesiteConfig.pm,v 1.7 2010-01-12 09:41:42 jm14 Exp $
...
$Id: PfampredictedactivesiteConfig.pm,v 1.7 2010-01-12 09:41:42 jm14 Exp $
...
sub _setColour{
  ...
  if($markup->end){
    ...
    $markup->colour( Convert::Color->new( 'rgb8:E469FE') );
  }
