...
=head2 new
  ...
  The new method gets a new instance of the PfamJobDBManger and trys to connect to the database.
  The default options can be overridden by suppling an array of key values pairs.
  
  my $pfamJobDB = Bio::Pfam::PfamJobsDBManager->new( [ port, 2187, password, secret ] );
...
sub new {
    ...
    eval{
     $self->{'schema'} = PfamJobs->connect("dbi".
				       ":".$self->{driver}.
				       ":".$self->{database}.
				       ":".$self->{host}.
				       ":".$self->{port},
