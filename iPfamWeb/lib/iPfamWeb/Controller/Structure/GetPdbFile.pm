...
# jt6 20060731 WTSI
#
# $Id: GetPdbFile.pm,v 1.1 2009-12-08 10:24:59 pg6 Exp $

=head1 NAME

iPfamWeb::Controller::Structure::GetPdbFile - serve a PDB file

=cut

package iPfamWeb::Controller::Structure::GetPdbFile;

=head1 DESCRIPTION

Retrieves a specified PDB file from the model and serves it up with
the appropriate MIME type (chemical/x-pdb). Relies on
L<Structure::begin|iPfamWeb::Controller::Structure/"begin : Private"> to
